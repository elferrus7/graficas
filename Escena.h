...
class Objeto
{
  public:
    ...
    map <unsigned long,KeyFrame *> keyFrames;
    GLuint hitName;
    ...
    void agregaKeyFrame(unsigned long frame,
...
public:
    ...
    GLfloat rotX,rotY,rotZ;
    GLfloat escalaX,escalaY,escalaZ;
    KeyFrame(GLfloat posX,GLfloat posY,GLfloat posZ, GLfloat rotX,GLfloat rotY,GLfloat rotZ,GLfloat escalaX,GLfloat escalaY,GLfloat escalaZ);
};
...
public:
    ...
    int poseactual;
    vector <Modelo *> poses;
    Poses(char* prefijo,int nposes,int framerate);
    ~Poses();
    void forma();
};

// Declaraciones para Escena.h
